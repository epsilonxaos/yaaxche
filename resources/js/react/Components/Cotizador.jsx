...
export const Cotizador = () => {
    ...
    useEffect(() => {
      if (selectedLote != null && selectedMensualidad != null) {
        ...
        setMensualidades(((selectedLote - (selectedLote * 0.12)) / selectedMensualidad).toFixed(2));
      }else{
      setEnganche(0);
      setMensualidades(0);
    }
  ...
  return (
    <div className='container-fluid cotizador-container'>
        ...
        <div className='info-container'>
            ...
            <a href="#contacto-section" className='button'>Precios desde $46,000</a>
            <h6>12% de enganche</h6>
            <p>Financiamiento de 6, 12, 36 y <b><i>hasta 48 meses.</i></b></p>
        </div>
        <div className='cotizador'>
                ...
                <form action="">
                    <div className="row justify-content-evenly">
                        ...
                        <Select options={data.lotes} onChange={handleLoteChange} styles={customStyles} placeholder="Elija un lote a cotizar"/>
                        </div>
                        <div className="col-xs-10 col-sm-10 col-md-5 col-lg-5">
                          <label>
                            Enganche - 12%
                          </label>
                        <input type="text" readOnly value={`${enganche}`} placeholder="12% Enganche"/>
                        </div>
                        <div className="col-xs-10 col-sm-10 col-md-5 col-lg-5">
                          <label>
                            Mensualidades
                          </label>
                        <Select options={data.mensualidades} onChange={handleMensualidadChange} styles={customStyles} placeholder="Mensualidades" />
                        </div>
                        <div className="col-xs-10 col-sm-10 col-md-5 col-lg-5">
                          <label>
                            Pago mensual
                          </label>
                        <input type="text" readOnly value={`${mensualidades}`} placeholder="Mensualidades"/>
                        </div>
                    </div>
                </form>
                <span>Información meramente informativa y sujeto a cambio de precio sin previo aviso*</span>
            </div>
    </div>
  )
}
